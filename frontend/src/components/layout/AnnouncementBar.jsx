...
export function AnnouncementBar({ items = [] }) {
  const defaultMessage =
    'MEGA SALE: Flat 15% OFF on ALL Products! | Hurry! Limited Time Offer Apply HEATWAVE10 and grab your discount before it is gone! | Offer ends 15 July 2026';
  const message = items.length ? items.join('   |   ') : defaultMessage;
